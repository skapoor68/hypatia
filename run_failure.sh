...
cd ../../satgenpy
python -m satgen.post_analysis.main_print_routes_and_rtt ../out ../paper/satellite_networks_state/gen_data/$constellation_name $timestep $duration $(($src + 1584)) $(($dest + 1584))